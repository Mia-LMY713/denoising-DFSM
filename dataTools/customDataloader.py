...
class customDatasetReader(Dataset):
    ...
    def __getitem__(self, i):
        ...
        self.inputImage = "./Datasets/train/Teeth/input_crops/" + extractFileName(self.image_list[i])
        noiseModel = self.transformHRGT( Image.open(self.inputImage))
        
        # return self.gtImageHR, noiseModel
        return  self.gtImageHR,noiseModel
